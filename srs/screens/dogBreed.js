        ...
        <View style={{width: '90%'}}>
          ...
          <View style={styles.view}>
            <TouchableOpacity
              style={{
                ...styles.touch,
                backgroundColor: mixedBreedSelected ? '#ECAC50' : 'transparent',
              }}
              onPress={() => {
            ...
            <TouchableOpacity
              style={{
                ...styles.touch,
                backgroundColor: pureBreedSelected ? '#ECAC50' : 'transparent',
              }}
              onPress={() => {
          ...
          <View style={styles.view}>
            ...
            <TouchableOpacity
              style={{
                ...styles.touch,
                backgroundColor: indieBreedSelected ? '#ECAC50' : 'transparent',
              }}
              onPress={() => {
                setMixedBreedSelected(false);
                setPureBreedSelected(false);
